...
export default function ScrollerLine3({fullCompData}) {
            ...
            return (
                {
                    ...
                    data: fullCompData.filter(e => e.dist_id_alt === id.dist_id_alt).map(e => e.norm_exp_wh),
                    borderColor:  id.dist_id_alt === '1500000' ? 'rgb(255, 99, 132)' : 'rgb(169, 169, 169)',
                    backgroundColor:  id.dist_id_alt ==='1500000' ? 'rgb(255, 99, 132)' : 'rgb(169, 169, 169)' 
                }
            )
        })
    }
