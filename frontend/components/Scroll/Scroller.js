    ...
    <div>
      ...
      >
            ...
            <Step style={stepStyle} data={0}>
              <div style={stepStyle}>
                <div className="text-center text-xl">
                  <span>
                    In 2019, New York City&#39;s School District 15 was a
                    racially diverse district
                    <br />
                    <br />
                    ...
                    <b>
                      ...
                      <span className="text-whitestudents">30% White</span>{" "}
                      <br />
                      <span className="text-asian">13% Asian</span> <br />
                      <span className="text-blackstudents">13% Black</span>{" "}
                      <br />
              ...
              <div style={stepStyle}>
                <div className="text-center text-xl">
                  <span>
                    ...
                    <br />
                    <br />
                    The average non-White student&#39;s school had <b>
                      24%
                    </b>{" "}
                    White students
                    <br />
        ...
        <div style={graphicStyle}>
          <div className="w-3/4">{charts()}</div>
        </div>
      </div>
      ...
      <div className="sticky w-screen h-screen flex flex-col py-10 items-center justify-between">
        <div className="flex flex-col px-4 items-center">
          <span className="font-raleway inline-flex items-center text-center text-xl">
            ...
            <br />
            <br />
            Use the dashboard to visualize demographics and understand
            segregation levels in different areas over time
          </span>
        </div>
